...
trap 'echo "❌ Planning phase failed at line $LINENO" >&2' ERR
...
log "🎯 Why Grok? Handles ambiguity, research, and synthesis best."
...
echo "3. 🎯 Analyzing project scope..."
...
echo
echo "🎉 Planning & Research Phase Complete!"
echo "======================================"
echo
echo "📄 Generated: $SPEC_FILE"
echo "🔄 Next: Run architecture-design.sh"
echo
echo "💡 Pro Enhancements:"
echo "   • Use Grok 4's expanded context for detailed plans"
echo "   • Enable 'Heavy' mode for multi-faceted analysis"
echo
echo "🤝 Involve Others:"
echo "   • Query Codex for pseudocode sketches if needed"
echo
echo "🎨 Fit for Python/TS:"
echo "   • Suggests async patterns or type safety"
echo
echo "➡️  Transition:"
echo "   • Export as Markdown; paste into IDE"
