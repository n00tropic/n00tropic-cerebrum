...
* **Tutorial** - Learning-oriented, greenfield walk-throughs (e.g., provisioning
 frontier workspaces)
* **How-to Guide** - Task-oriented, focused jobs with clear outcomes (e.g.,
...
npm i -g @antora/CLI@latest @antora/site-generator@latest
