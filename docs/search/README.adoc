...
Artifacts go to `build/site/` (Lunr), Typesense collections, the log under `docs/search/logs/`, and a JSON summary (`.log.json`) that downstream dashboards can ingest.
